...
class Ui_DATMantMainWindow(object):
    def setupUi(self, DATMantMainWindow):
        ...
        self.btnReload = QtWidgets.QPushButton(self.gbAnnotWindow)
        self.btnReload.setObjectName("btnReload")
        self.horizontalLayout_4.addWidget(self.btnReload)
    ...
    def retranslateUi(self, DATMantMainWindow):
        ...
        self.label.setText(_translate("DATMantMainWindow", "Has defect mask?"))
        ...
        self.btnPrev.setText(_translate("DATMantMainWindow", "Previous image"))
        self.btnReload.setText(_translate("DATMantMainWindow", "Reload image (lose progress!)"))
        self.btnMode.setText(_translate("DATMantMainWindow", "Mode [Marking defects]"))
        self.btnNext.setText(_translate("DATMantMainWindow", "Next image"))
