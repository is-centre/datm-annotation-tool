...
class Ui_DATMantMainWindow(object):
    def setupUi(self, DATMantMainWindow):
        ...
        self.gviewEditor = QtWidgets.QGraphicsView(self.gbAnnotWindow)
        self.gviewEditor.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.gviewEditor.setObjectName("gviewEditor")
        self.figThinFigure.addWidget(self.gviewEditor)
    ...
    def retranslateUi(self, DATMantMainWindow):
        ...
        self.btnClear.setText(_translate("DATMantMainWindow", "[R] Clear ALL annotations"))
